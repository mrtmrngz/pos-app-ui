...
const Cart = () => {
    return (
        <div className="cart-wrapper flex flex-col h-full w-full">
            <div className="top w-full flex text-sm lg:text-xs xl:text-sm gap-x-5 items-center justify-between p-4 bg-orange-color text-white">
            ...
            <div className="bottom border-t border-border-color mt-auto">
                <div className="wrapper">
                    ...
                    <div className="flex flex-col items-center justify-center gap-y-2 w-full px-2 py-3">
                        <Button className="btn primary !w-full rounded-2xl">Checkout</Button>
